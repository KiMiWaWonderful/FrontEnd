<template>
  <div id="container">
    ...
    <!-- <el-button @click="carMove">车动起来</el-button> -->
              ...
              <div class="route-header">
                <div class="searchbox-content-common route-tabs cc_cursor">
                  ...
                  <div class="tab-item bus-tab cc_pointer" data-index="bus">
                    <el-checkbox v-model="checkedBus" @change="resetDiscountValue('0')">
                      <i></i>
                      <span>公交</span>
                    </el-checkbox>
                  </div>
                  <div class="tab-item drive-tab cc_pointer" data-index="drive">
                    <el-checkbox v-model="checkedDrive" @change="resetDiscountValue('1')">
                      <i></i>
                      <span>驾车</span>
                    </el-checkbox>
                  </div>
                  <div class="tab-item walk-tab cc_pointer" data-index="walk">
                    <el-checkbox v-model="checkedWalk" @change="resetDiscountValue('2')">
                      <i></i>
                      <span>步行</span>
                    </el-checkbox>
                  </div>
                  <div class="tab-item bike-tab cc_pointer" data-index="bike">
                    <el-checkbox v-model="checkedBike" @change="resetDiscountValue('3')">
                      <i></i>
                      <span>骑行</span>
                    </el-checkbox>
                  </div>
 ...
 import jsonpAdapter from 'axios-jsonp';
  ...
  export default {
    ...
    data() {
      return {
        // 历史栅栏
        polylinePath: [{lat: 21.676292,lng: 110.913432},
                        {lat: 21.674478,lng: 110.907755},
                        {lat: 21.669708,lng: 110.90912},
                        {lat: 21.66729,lng: 110.91645},
                        {lat: 21.669574,lng: 110.92069},
                        {lat: 21.674008,lng: 110.921122},
                        {lat: 21.67656,lng: 110.915013}],

        test: {lng: 110.91608047485352, lat: 21.661895340414247},
   ...
   //   this.path.c
    ...
    methods: {
      ...
      carMove (){
        this.test.lat =  this.test.lat + 0.0006
      ...
      resetDiscountValue (type){
        if (type === '0') {
          this.checkedDrive = false
          this.checkedWalk = false
          this.checkedBike = false
        } else if (type === '1') {
          this.checkedBus = false
          this.checkedWalk = false
          this.checkedBike = false
        } else if (type === '2'){
          this.checkedBus = false
